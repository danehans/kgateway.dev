...
The `ingress-nginx` provider defines the source for translating Ingress resources with NGINX-specific annotations. Some annotations may be translated into
kgateway resources or user-facing notifications.
